...
import com.github.vagnerlg.observability.kafka.KafkaObservabilityConfiguration;
...
@AutoConfiguration
@AutoConfigureAfter(name = "org.springframework.boot.micrometer.observation.autoconfigure.ObservationAutoConfiguration")
@Import({
        ...
        KafkaObservabilityConfiguration.class
})
